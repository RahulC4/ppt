...
# ------------------------------------------------------------
# ✅✅✅ PPT BUILDER WITH MSO AUTO-SIZE FIX ✅✅✅
# ------------------------------------------------------------
def build_ppt(slides):
    ...
    for sp in slides:
        ...
        # ✅✅✅ THIS PREVENTS TEXT SHRINKING FOREVER ✅✅✅
        ...
        # ✅ IMAGE SLIDES (DO NOT TOUCH ALIGNMENT)
        ...
        # ✅ NON-IMAGE SLIDES (FULL-WIDTH — DO NOT TOUCH ALIGNMENT)
        else:
            body.left = Inches(0.5)
