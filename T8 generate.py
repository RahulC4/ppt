...
# ------------------------------------------------------------
# ✅✅✅ PPT BUILDER WITH TITLE + AGENDA + THANK YOU ✅✅✅
# ------------------------------------------------------------
def build_ppt(slides, agenda_titles, image_required):
    ...
    if image_required:
        img = generate_visual_image("Agenda professional illustration")
        if img:
    ...
    thankyou = prs.slides.add_slide(prs.slide_layouts[1])
    thankyou.shapes.title.text = "Thank You"
    thankyou.placeholders[1].text = "Questions & Discussion"
