# ============================================================
# generate_ppt_auto.py – NO JSON | Images Checkbox | Safe Scaling | AUTO SIZE FIX
# ============================================================
...
# ------------------------------------------------------------
# ✅✅✅ PPT BUILDER WITH IMAGE OVERLAP FIX ✅✅✅
# ------------------------------------------------------------
def build_ppt(slides):
    ...
    for sp in slides:
        ...
        # ✅ BASE BODY POSITION (USED BY BOTH MODES)
        body.top = slide.shapes.title.top + slide.shapes.title.height + Inches(0.3)

        # ✅✅✅ IMAGE MODE — SAFE FIX (NO TITLE OVERLAP) ✅✅✅
        if sp.get("image_path"):
            try:
                # ✅ FORCE BODY TO STAY BELOW TITLE (FIX)
                body.top = slide.shapes.title.top + slide.shapes.title.height + Inches(0.4)
        ...
        # ✅ NON-IMAGE MODE — FULL WIDTH (UNCHANGED)
        else:
            body.left = Inches(0.5)
