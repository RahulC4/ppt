...
from design_extractor import process_blob as design_process_blob
            ...
            try:
                ...
                if not refs:
                    st.warning(
                        ...
                        "Please rephrase your prompt using topics related to existing decks "
                        "or upload a new sample PPT."
                    )
    ...
    if not prompt.strip():
        ...
        with st.spinner("Generating final PowerPoint..."):
            try:
                ...
                # ✅ HANDLE "NO MATCH" MESSAGE GRACEFULLY
                if log.get("error"):
