# ============================================================
# generate_ppt.py – FINAL FIXED (design matching works now)
# ============================================================
...
# ------------------------------------------------------------
# FIXED: DESIGN JSON MATCHING
# ------------------------------------------------------------
def extract_design_for_slide(design_context, matched_ppt_name, matched_slide_idx):
    """
    Matches PPT name + slide index.
    FIXED: Compare only file names, not full blob paths.
    """
